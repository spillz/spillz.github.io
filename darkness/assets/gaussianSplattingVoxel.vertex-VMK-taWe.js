import{g as a,H as o,I as r,J as n,K as l,P as s}from"./index-CS91MK8K.js";const e="gaussianSplattingVoxelVertexShader",i=`#include<__decl__gaussianSplattingVertex>
...
#endif
vPatchPosition=position.xy;}`;a.ShadersStore[e]||(a.ShadersStore[e]=i);const p=[o,r,n,l,s];for(const t of p)a.IncludesShadersStore[t.name]||(a.IncludesShadersStore[t.name]=t.shader);const c={name:e,shader:i};export{c as gaussianSplattingVoxelVertexShader};
