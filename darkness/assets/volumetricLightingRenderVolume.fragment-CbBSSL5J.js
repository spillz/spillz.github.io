import{g as e,s as r,o}from"./index-CaWfqv5k.js";const i="volumetricLightingRenderVolumePixelShader",n=`#include<sceneUboDeclaration>
...
`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=n);const s=[r,o];for(const t of s)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const f={name:i,shader:n};export{f as volumetricLightingRenderVolumePixelShaderWGSL};
