import{g as o}from"./index-W7idw9Bp.js";const e="noisePixelShader",i=`uniform float brightness;uniform float persistence;uniform float timeScale;varying vec2 vUV;vec2 hash22(vec2 p)
...
`;o.ShadersStore[e]||(o.ShadersStore[e]=i);const f={name:e,shader:i};export{f as noisePixelShader};
