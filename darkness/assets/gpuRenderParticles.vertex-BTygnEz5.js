import{g as e,r as i,t as n,l as s,v as a,w as f,x as l}from"./index-BRguVNLM.js";const r="gpuRenderParticlesVertexShader",o=`uniform view: mat4x4f;uniform projection: mat4x4f;uniform translationPivot: vec2f;uniform worldOffset: vec3f;
#ifdef LOCAL
...
`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=o);const v=[i,n,s,a,f,l];for(const t of v)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const c={name:r,shader:o};export{c as gpuRenderParticlesVertexShaderWGSL};
