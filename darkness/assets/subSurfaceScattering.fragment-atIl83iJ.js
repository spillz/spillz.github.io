import{g as e,q as s,ar as o}from"./index-CaWfqv5k.js";const t="fibonacci",a=`fn rcp(x: f32)->f32
{return 1./x;}
...
`;e.ShadersStoreWGSL[n]||(e.ShadersStoreWGSL[n]=f);const S=[s,c,o,u];for(const r of S)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const d={name:n,shader:f};export{d as subSurfaceScatteringPixelShaderWGSL};
