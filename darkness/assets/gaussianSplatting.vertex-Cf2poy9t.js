import{g as e,H as t,I as r,J as n,K as l,M as s,N as f,z as c,O as d,P as p,Q as S,V as u,W as m}from"./index-D_aBcswC.js";const a="gaussianSplattingVertexShader",i=`#include<__decl__gaussianSplattingVertex>
...
`;e.ShadersStore[a]||(e.ShadersStore[a]=i);const _=[t,r,n,l,s,f,c,d,p,S,u,m];for(const o of _)e.IncludesShadersStore[o.name]||(e.IncludesShadersStore[o.name]=o.shader);const D={name:a,shader:i};export{D as gaussianSplattingVertexShader};
