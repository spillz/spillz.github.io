import{g as t,s as i,o,u as s}from"./index-BRguVNLM.js";const r="gaussianSplattingVoxelVertexShader",a=`#include<sceneUboDeclaration>
...
`;t.ShadersStoreWGSL[r]||(t.ShadersStoreWGSL[r]=a);const n=[i,o,s];for(const e of n)t.IncludesShadersStoreWGSL[e.name]||(t.IncludesShadersStoreWGSL[e.name]=e.shader);const u={name:r,shader:a};export{u as gaussianSplattingVoxelVertexShaderWGSL};
